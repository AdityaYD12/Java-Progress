public class GamePlayer {
    ...
    public void Run(int incrementPositionX, int incrementPositionY)
    {
        positionX = positionX + incrementPositionX;
        positionY = positionY + incrementPositionY;
        System.out.println("Player still running...  Current X Position is " + positionX + ", " + positionY);
    }
}   
